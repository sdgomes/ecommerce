...
AS
    BEGIN
        ...
        (
            ...
            ID_CLIENTE BIGINT,
            CODIGO VARCHAR(64) DEFAULT SUBSTRING(CONVERT(varchar(255), NEWID()), 1, 8),
            DESCONTO INTEGER DEFAULT ((ABS(CHECKSUM(NEWID())) % 55) + 5),
        ...
        (
            ...
            CODIGO INT DEFAULT ((ABS(CHECKSUM(NEWID())) % 99999) + 10000),
            TIPO VARCHAR(255) NOT NULL,
            PAGAMENTO VARCHAR(125) NOT NULL,
            SUBTOTAL FLOAT,
            REEMBOLSO BIT DEFAULT 0,
            TROCA BIT DEFAULT 0,
            DEVOLUCAO BIT DEFAULT 0,
            FRETE FLOAT,
            DESCONTOS FLOAT,
