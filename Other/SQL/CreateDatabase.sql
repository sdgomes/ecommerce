...
AS
    BEGIN
        ...
        ADD CONSTRAINT ECM_DESCONTO_PK
        ...
        CREATE TABLE ECM_SOLICITACOES
        (
            ID_SOLICITACAO BIGINT IDENTITY(1, 1) NOT NULL,
            CODIGO VARCHAR(255) NOT NULL,
            GRUPO_CODIGO VARCHAR(255) NOT NULL,
            ID_TRANSACAO BIGINT NOT NULL,
            ID_PRODUTO BIGINT,
            ID_FUNCIONARIO BIGINT,
            ID_DESCONTO BIGINT,
            ...
            TIPO VARCHAR(25) NOT NULL,
            PRECO FLOAT NOT NULL,
            APROCACAO_1 BIT DEFAULT 0 NOT NULL,
            APROCACAO_2 BIT DEFAULT 0 NOT NULL,
            MOTIVO_SOLICITACAO VARCHAR(520) NOT NULL,
            MOTIVO_RECUSA VARCHAR(520),
        ...
        ALTER TABLE ECM_SOLICITACOES
        ADD CONSTRAINT ECM_SOLICITACOES_PK
            PRIMARY KEY CLUSTERED (ID_SOLICITACAO, ID_TRANSACAO, CODIGO)
            WITH (ALLOW_PAGE_LOCKS = ON, ALLOW_ROW_LOCKS = ON);
        ...
        ALTER TABLE ECM_SOLICITACOES
        ADD CONSTRAINT FK_SOLICITACOES_TO_TRANSACAO_ECM
            FOREIGN KEY (ID_TRANSACAO)
            REFERENCES ECM_TRANSACOES (ID_TRANSACAO) ON DELETE NO ACTION ON UPDATE NO ACTION;
            
        ALTER TABLE ECM_SOLICITACOES
        ADD CONSTRAINT FK_SOLICITACOES_TO_FUNCIONARIOS_ECM
            FOREIGN KEY (ID_FUNCIONARIO)
            REFERENCES ECM_FUNCIONARIOS (ID_FUNCIONARIO) ON DELETE NO ACTION ON UPDATE NO ACTION;
            
        ALTER TABLE ECM_SOLICITACOES
        ADD CONSTRAINT PK_SOLICITACOES_TO_DESCONTOS_ECM
            FOREIGN KEY (ID_DESCONTO)
            REFERENCES ECM_DESCONTOS (ID_DESCONTO) ON DELETE NO ACTION ON UPDATE NO ACTION;
 
        ALTER TABLE ECM_SOLICITACOES
        ADD CONSTRAINT PK_SOLICITACOES_TO_ETAPAS_ECM
            FOREIGN KEY (ID_ETAPA)
            REFERENCES ECM_ETAPAS (ID_ETAPA) ON DELETE NO ACTION ON UPDATE NO ACTION;

        ALTER TABLE ECM_SOLICITACOES
        ADD CONSTRAINT PK_SOLICITACOES_TO_PRODUTOS_ECM
            FOREIGN KEY (ID_PRODUTO)
            REFERENCES ECM_PRODUTOS (ID_PRODUTO) ON DELETE NO ACTION ON UPDATE NO ACTION;
